...
const cardDetails=[
  ...
  },
  {
    ...
    ArtProtect:true,
    analyticsAndInsight:true,
    link:"https://razorpay.com/payment-link/plink_MvgWFS7IQJ4K8h/test"
  }
]
...
//               </ul>
//               <button  onClick={()=>window.location.href="https://rzp.io/i/GqbX6Knq"} className='btn btn-success btn-lg w-100 btn-success'>{subscription === "basic" ? "Upgrade" : subscription === "premium" ? "Current Plan" : subscription === "elite" ? "Change Plan" : ""}</button>
//             </div>
//           </div>
//         </div>
//         <div className='col'>
...
//               </ul>
//               <button onClick={()=>window.location.href="https://razorpay.com/payment-link/plink_MvgWFS7IQJ4K8h/test"} className='btn btn-success btn-lg w-100 btn-success'>{subscription === "basic" ? "Upgrade" : subscription === "premium" ? "Upgrade" : subscription === "elite" ? "Current Plan" : ""}</button>
//             </div>
//           </div>
//         </div>
//       </div>
